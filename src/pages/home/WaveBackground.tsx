const WaveBackground = (): JSX.Element => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
      <svg
        className="absolute top-0 left-0 w-[200%] h-[60%] animate-wave-slow scale-y-[-1]"
      ...
      <svg
        className="absolute top-0 left-0 w-[200%] h-[50%] animate-wave-mid scale-y-[-1]"
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
      >
        <path
      ...
      <svg
        className="absolute top-0 left-0 w-[200%] h-[40%] animate-wave-fast scale-y-[-1]"
        viewBox="0 0 1440 320"
        preserveAspectRatio="none"
      >
        <path
