    ...
    return (
      <PageWrapper>
        ...
        <div className="max-w-3xl mx-auto px-4 py-20 text-center">
          <h1 className="font-display text-3xl font-black text-foreground">Categorie introuvable</h1>
          <Link to="/rights" className="text-primary font-semibold mt-4 inline-block hover:underline">Retour a Vos Droits</Link>
        </div>
      </PageWrapper>
    );
  }
    ...
    <PageWrapper>
      ...
      <article className="max-w-3xl mx-auto px-4 md:px-6 py-12">
        ...
        <p className="text-foreground mt-6 leading-relaxed">
          Cette page sera enrichie prochainement avec des fiches pratiques detaillees sur le theme "{cat.titre}".
          En attendant, n'hesitez pas a nous contacter pour toute question.
        </p>
        <Link to="/rights" className="text-primary font-semibold mt-8 inline-block hover:underline">&larr; Retour a Vos Droits</Link>
      </article>
    </PageWrapper>
  );
};
